...
class IPTVSubscriptionController extends Controller
{
    ...
    public function fetch(Request $request)
    {
        ...
        return Datatables::of($list)
            ...
            ->addColumn('action', function($row){
                ...
                if ($row->status == 'pending') {
                    $html .= '
                        <a href="'.route('admin.iptv.subscription.edit', $row->id).'" class="me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Update Record">
                ...
                if ($row->status == 'started') {
                    $html .= '
                        <a href="'.route('admin.iptv.subscription.suspend', $row->id).'" class="me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Suspend Subscription">
                            <i class="las la-ban fs-3 cursor-pointer text-primary"></i>
                        </a>
                    ';
                }
                $html .= '
                    <a href="'.route('admin.iptv.subscription.delete', $row->id).'" class="me-2 delete-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete Record">
    ...
    {
        return view('admin.iptv_subscription.edit', get_defined_vars());
    }
