...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-dark">IPTV Services</li>
    </ul>
@endsection
    ...
    <div class="card">
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar">
                <a href="{{ route('admin.iptv.service.add') }}" class="btn btn-sm btn-primary">Add New Record</a>
            </div>
        </div>
...
@section('js')
    <script src="{{ asset('admin/js/iptv-services/index.js?v='.rand()) }}"></script>
@endsection
