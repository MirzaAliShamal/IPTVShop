...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('admin.product.index') }}" class="text-muted text-hover-primary">Products</a>
        </li>
        <li class="breadcrumb-item">
            <span class="bullet bg-gray-200 w-5px h-2px"></span>
        </li>
...
@section('content')
    <div class="card">
        ...
        <div class="card-body py-10">
            <form action="{{ route('admin.product.save') }}" method="POST" class="add-form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
...
@section('js')
    ...
    <script src="{{ asset('admin/js/products/add.js?v='.rand()) }}"></script>
@endsection
