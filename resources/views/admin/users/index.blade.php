...
@section('content')
    ...
    <div class="modal fade" id="adjust_details_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog mw-600px">
            <div class="modal-content">
                <div class="modal-header" id="adjust_details_modal_header">
                    <h2 class="fw-bolder">Adjust Balance</h2>
                    <div class="btn btn-icon btn-sm btn-active-icon-primary" onclick="closeModal('#adjust_details_modal')">
...
@section('js')
    <script src="{{ asset('admin/js/users/index.js?v='.rand()) }}"></script>
@endsection
