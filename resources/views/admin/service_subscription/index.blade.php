...
@section('title', 'Serivce Subscriptions')
@section('page-title', 'Serivce Subscriptions')
...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-dark">Serivce Subscriptions</li>
    </ul>
@endsection
...
@section('js')
    <script src="{{ asset('admin/js/service-subscription/index.js?v='.rand()) }}"></script>
@endsection
