...
@section('page-title', 'Service Subscriptions')
...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('admin.service.subscription.index') }}" class="text-muted text-hover-primary">Service Subscriptions</a>
        </li>
        <li class="breadcrumb-item">
            <span class="bullet bg-gray-200 w-5px h-2px"></span>
        </li>
...
@section('content')
    <div class="card">
        ...
        <div class="card-body py-10">
            <form action="{{ route('admin.service.subscription.update', $subscription->id) }}" method="POST" class="edit-form" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <a href="{{ route('admin.service.subscription.index') }}" class="btn btn-secondary">
                            Go Back
                        </a>
                    </div>
                </div>
...
@section('js')
    ...
    <script src="{{ asset('admin/js/service-subscription/edit.js?v='.rand()) }}"></script>
@endsection
