            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion @routeis('admin.funds.card.*') here show @endrouteis">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <a class="menu-link @routeis('admin.funds.card.wire.transfer') active @endrouteis" href="{{ route('admin.funds.card.wire.transfer') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Wire Transfer</span>
                            </a>
                        </div>
                        <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link @routeis('admin.paypal.multiple.*') active @endrouteis" href="{{ route('admin.paypal.multiple.index') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                        ...
                        <span class="menu-title">PayPal Multiples</span>
                    </a>
                </div>
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion @routeis('admin.transaction.*') here show @endrouteis">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <a class="menu-link @routeis('admin.transaction.wire.transfer') active @endrouteis" href="{{ route('admin.transaction.wire.transfer') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Wire Transfers</span>
                            </a>
                        </div>
                        <div class="menu-item">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion @routeis('admin.setting.*') here show @endrouteis">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link @routeis('admin.setting.payment.method') active @endrouteis" href="{{ route('admin.setting.payment.method') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
