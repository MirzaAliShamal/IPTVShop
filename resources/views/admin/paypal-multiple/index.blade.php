...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-dark">PayPal Multiples</li>
    </ul>
@endsection
    ...
    <div class="card">
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar">
                <a href="{{ route('admin.paypal.multiple.add') }}" class="btn btn-sm btn-primary">Add New PayPal</a>
            </div>
        </div>
    ...
    <div class="modal fade" id="view_details_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog mw-600px">
            <div class="modal-content">
                <div class="modal-header" id="view_details_modal_header">
                    <h2 class="fw-bolder">Links</h2>
...
@section('js')
    <script src="{{ asset('admin/js/paypal-multiple/index.js?v='.rand()) }}"></script>
@endsection
