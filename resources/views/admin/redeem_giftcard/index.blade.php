...
@section('title', 'Redeem Gift Cards')
@section('page-title', 'Redeem Gift Cards')
...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-dark">Redeem Gift Cards</li>
    </ul>
@endsection
...
@section('js')
    <script src="{{ asset('admin/js/redeem-gift-card/index.js?v='.rand()) }}"></script>
@endsection
