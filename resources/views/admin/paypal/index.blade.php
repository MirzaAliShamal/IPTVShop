...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-dark">PayPal Accounts</li>
    </ul>
@endsection
    ...
    <div class="card">
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar">
                <a href="{{ route('admin.paypal.account.add') }}" class="btn btn-sm btn-primary">Add New Record</a>
            </div>
        </div>
...
@section('js')
    <script src="{{ asset('admin/js/paypal/index.js?v='.rand()) }}"></script>
@endsection
