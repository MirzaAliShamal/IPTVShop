                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-lg-6 col-12 text-center">
                            <p>Try our IPTV service with a 10-minute test. Click "Get a Test" to explore all channels instantly, no setup required. If you're still unsure about purchasing, visit our Telegram group to see positive reviews from our satisfied customers</p>
                            <div class="d-flex flex-row justify-content-center gap-3 mt-4">
                                <a href="" class="btn btn-primary">Get a test</a>
