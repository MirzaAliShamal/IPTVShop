                ...
                <div class="card-body">
                    <div class="row justify-content-center mb-5">
                        <div class="col-lg-6 col-12 text-center">
                            ...
                            <h4 class="mb-5">Email Confirmed</h4>
                            <p class="mb-3">Your email address has been successfully confirmed. Your 24-hour IPTV credentials will be displayed shortly under “Test IPTV”.</p>
