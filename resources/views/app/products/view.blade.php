                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-md-3 col-sm-12 col-12 mb-3">
                            <img src="{{ Storage::url($product->logo) }}" class="img-fluid detail-page-image" alt="{{ $product->title }}">
                        </div>
                        <div class="col-lg-9 col-md-9 col-sm-12 col-12 mb-3">
                            <div class="d-flex flex-column gap-3">
                                ...
                                <a href="{{ route('products.purchase', $product->id) }}" class="btn btn-secondary purchase-btn">Buy Now</a>
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="tab-content detail-page-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="nav-reviews" role="tabpanel" aria-labelledby="nav-reviews-tab" tabindex="0">
                                    @if (!$product->reviews()->where('user_id', Auth::user()->id)->exists())
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <h4>Reviews (Average: {{ number_format($product->reviews()->avg('rating'), 1) }})</h4>
