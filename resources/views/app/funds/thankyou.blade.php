                ...
                <div class="card-body">
                    <div class="row justify-content-center mb-5">
                        <div class="col-lg-6 col-12 text-center">
                            ...
                            <h4 class="mb-5">Thank you for topping up your account! Our system is currently verifying your payment.</h4>
                            <p class="mb-3">As soon as it is confirmed, the amount will be reflected in your balance.</p>
                            <p class="mb-3">In the meantime, feel free to explore articles on our blog and join our Telegram groups where you can find reviews from our customers.</p>
                            <p class="mb-3">If you have any questions, please contact our customer ssupport via live chat, Telegram, WhatsApp, or email.</p>
