...
@section('page-title', 'Insufficient Balance')
                ...
                <div class="card-body">
                    <div class="row justify-content-center mb-5">
                        <div class="col-lg-6 col-12 text-center">
                            ...
                            <h4 class="mb-5">Your account balance is insufficient. Please top up your account using one of our payment methods.</h4>
                            <p class="mb-3">This will allow you to complete your purchase seamlessly. Thank you</p>
